...
export class Toaster extends AbstractPureComponent {
  ...
  render() {
    ...
    const classes = classNames('b-toast-container', this.getPositionClasses(), this.props.className);
  ...
  getPositionClasses() {
    ...
    return positions.map(p => `b-toast-container-${p.toLowerCase()}`);
  }
}
